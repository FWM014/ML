...
def split_candidates(x: np.ndarray, y: np.ndarray) -> pd.DataFrame:
    ...
    [0.5, 1.5, 2.5, 3.5, 4.5, 5.5]; weighted_gini is 0.400 at 0.5 and 0.267 at 1.5
    (the best). Note the array actually holds 6 stayed / 4 churned, so the parent
    entropy is 0.971 and info_gain at 1.5 is 0.420 (the chapter's printout assumed a
